...
(function () {
	...
	function initArea(proceed, chart, options) {
		...
		if (this.chart.polar) {
			...
			/**
			 * Overridden method to close a segment path. While in a basketsesian plane the area 
	 ...
	 * basketsesian plane, where plotX denotes the angle in radians and (yAxis.len - plotY) is the pixel distance from
	 * center. 
	 */

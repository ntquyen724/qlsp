    ...
    $.extend(Jcrop.prototype, {
        ...
        deleteSelection: function() {
            if (this.ui.selection) {
                try {
                    OCR.deleteSelection(this.ui.selection);
                } catch (e) {
                } //edit by xuanhieu@jamcorp.vn

                this.removeSelection(this.ui.selection);
                if (this.ui.multi.length > 0) {
                    ...
                    var i = 0;
                    this.ui.selection.refresh();
                    var shapes = this.container.find(".jcrop-shades").find("div").each(function () {
                        if(i == 3) {
                            var h = jQuery(this).height();
                            var top = jQuery(this).position().top;
                            jQuery(this).css({ height: (h + top) + "px", top: "0px" });
                        }
                        i++;
                    });
                }//edit by xuanhieu@jamcorp.vn

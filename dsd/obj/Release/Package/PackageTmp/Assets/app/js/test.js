...
jQuery(window).bind("load", function () {
    ...
    jQuery('#dashboard-bandwidth-chart')
        .data('width', jQuery('.box-tabbs')
            .width() - 20);
    ...
    var placeholder = jQuery("#dashboard-pie-chart-sources");
    placeholder.unbind();
    ...
    //var placeholder = jQuery("#dashboard-chart-visits");
    //var plot = jQuery.plot(placeholder, data2, options);
    ...
    //var plot = jQuery.plot("#dashboard-chart-realtime", getSeriesObj(), {
    //    yaxis: {
    //        color: '#f3f3f3',
    //        min: 0,
    //        max: 100,
